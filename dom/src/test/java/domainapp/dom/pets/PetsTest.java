...
public class PetsTest {
    ...
    public void setUp() throws Exception {
        pets = new Pets();
        pets.repositoryService = mockRepositoryService;
    }
    ...
    public static class Create extends PetsTest {
        ...
        public void happyCase() throws Exception {
            ...
            context.checking(new Expectations() {
                {
                    oneOf(mockRepositoryService).instantiate(Pet.class);
                    inSequence(seq);
                    will(returnValue(pet));

                    oneOf(mockRepositoryService).persist(pet);
                    inSequence(seq);
                }
            });
    ...
    public static class ListAll extends PetsTest {
        ...
        public void happyCase() throws Exception {
            ...
            context.checking(new Expectations() {
                {
                    oneOf(mockRepositoryService).allInstances(Pet.class);
